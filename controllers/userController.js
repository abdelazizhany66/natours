...
const multerStorge = multer.memoryStorage() //It is temporarily stored to process the image

const multerFilter = (req, file, cb)=>{
  if(file.mimetype.startsWith('image')){
    cb(null, true)
  }else{
    cb(null, new AppError('Not an image! Please upload only images.', 400),false)
  }
}
...
exports.userResizePhoto = (req, res, next)=>{
